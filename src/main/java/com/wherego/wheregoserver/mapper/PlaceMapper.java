...
public interface PlaceMapper {
    ...
    SimplePlaceDto toSimplePlaceDto(Place place);
    ...
    DetailPlaceDto toDetailPlaceDto(Place place);

    @Named("getTypeNames")
    static List<String> getTypeNames(Set<PlaceType> types){
        return MapperUtils.arrayToListString(types, "getType");
    }

    @Named("getAverageRating")
    static Float getAverageRating(Set<PlaceReview> reviews){
        return MapperUtils.arrayToFloatAverage(reviews, "getRating");
    }

    @Named("getTotalRating")
    static int getTotalRating(Set<PlaceReview> reviews){
        return reviews.size();
    }

    @Named("getGalleries")
    static List<String> getGalleries(Set<PlaceGallery> galleries){
        return MapperUtils.arrayToListString(galleries, "getImage");
    }

    @Named("getReviews")
    static Set<ReviewDetailDto> getReviews(Set<PlaceReview> reviews){
