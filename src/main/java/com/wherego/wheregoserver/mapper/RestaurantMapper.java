...
public interface RestaurantMapper  {
    ...
    SimpleRestaurantDto toSimpleRestaurantDto(Restaurant restaurant);
    ...
    DetailRestaurantDto toDetailRestaurantDto(Restaurant restaurant);
    ...
    static int getTotalRating(Set<RestaurantReview> reviews){
        return reviews.size();
    }

    @Named("getReviews")
    static Set<ReviewDetailDto> getReviews(Set<RestaurantReview> reviews){
        return MapperUtils.objectReviewToReviewDetail(reviews);
    }

    @Named("getGalleries")
    static List<String> getGalleries(Set<RestaurantGallery> galleries){
